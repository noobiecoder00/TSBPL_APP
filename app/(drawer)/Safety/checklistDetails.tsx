    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.section}>
          <View style={styles.formGroup}>
            ...
            <TextInput style={styles.input} value="Check 1" editable={false} />
          </View>
          ...
          <View style={styles.formGroup}>
            <Text style={styles.label}>Remarks</Text>
            <TextInput style={styles.input} placeholder="Enter Remarks" />
          </View>
      ...
      <View style={styles.section}>
        ...
        <TextInput
          ...
          placeholder="Give Any Additional Remarks..."
          multiline
          numberOfLines={3}
        />
      </View>
